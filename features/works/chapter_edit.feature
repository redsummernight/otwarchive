...
Feature: Edit chapters
  ...
  Given basic tags
    And I am logged in as "epicauthor"
  ...
  When I follow "Add Chapter"
    And I fill in "Chapter Number" with "2"
    And I fill in "of" with "100"
  ...
  When I follow "Add Chapter"
    And I fill in "Chapter Number" with "3"
    And I fill in "of" with "50"
  ...
  When I follow "Add Chapter"
    And I fill in "Chapter Number" with "17"
    And I fill in "of" with "17"
  ...
  When I follow "Edit"
    And I follow "3"
    And I fill in "Chapter Number" with "4"
    And I fill in "of" with "4"
  ...
  # Leave comments on some chapters
  When I am logged in as "reviewer"
    And I view the work "New Epic Work"
    And I follow "Chapter 1"
    And I post a comment "one fish"
    And I post a comment "two fish"
    And I follow "Next Chapter"
    And I post a comment "red fish"
    And I follow "Next Chapter"
    And I post a comment "blue fish"
    And I view the work "New Epic Work" in full mode
  ...
  Then I should see "Chapter 1"
    ...
    # Comments should follow new chapter order
    And "blue fish" should appear before "red fish"
    And "red fish" should appear before "one fish"
    # but the order of comments on a single chapter stays the same
    And "one fish" should appear before "two fish"
